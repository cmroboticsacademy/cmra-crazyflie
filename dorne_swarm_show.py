...
when using the field_relative argument.
...
uris = [
    'radio://0/80/2M/E7E7E7E7E7',  # cf_id 0, startup position [0.5, 0.5]
    'radio://0/80/2M/E7E7E7E7E8',  # cf_id 1, startup position [ 1, 1]
    'radio://0/80/2M/E7E7E7E7E9',  # cf_id 3, startup position [1.5, 1.5]
...
sequence = [
    ...
    (2,    0,      Goto(0.5,  0.5,   0.75, 1, field_relative)),
    (2,    2,      Goto(1.5,  1.5,   0.75, 1, field_relative)),

    (3,    1,      Goto(1,  1,   1.5, 1, field_relative)),

    (4,    0,      Goto(1.5, 0.5, 0.75, 2, field_relative)),
    (4,    2,      Goto(0.5, 1.5, 0.75, 2, field_relative)),

    (5,    0,      Goto(1.5, 1.5, 0.75, 2, field_relative)),
    (5,    2,      Goto(0.5, 0.5, 0.75, 2, field_relative)),

    (6,    0,      Goto(1.5, 1.5, 0.75, 2, field_relative)),
    (6,    2,      Goto(1.5, 0.5, 0.75, 2, field_relative)),

    (7,   0,      Goto(0.5, 0.5, 0.75, 2, field_relative)),
    (7,   2,      Goto(1.5, 1.5, 0.75, 2, field_relative)),
